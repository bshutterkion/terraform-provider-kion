...
func ComplianceLevelDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"data": schema.SingleNestedAttribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"compliance_program_id": schema.Int64Attribute{
									Computed:            true,
									Description:         "ID of the compliance program this level belongs to.",
									MarkdownDescription: "ID of the compliance program this level belongs to.",
								},
								...
								"id": schema.Int64Attribute{
									Computed:            true,
									Description:         "ID of the compliance level in the application.",
									MarkdownDescription: "ID of the compliance level in the application.",
								},
				...
				Computed:            true,
				Description:         "ComplianceLevelPaginated defines a paginated list of compliance levels.",
				MarkdownDescription: "ComplianceLevelPaginated defines a paginated list of compliance levels.",
			},
			"id": schema.Int64Attribute{
				Required:            true,
			...
			"query": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "Query string for Level names. Optional",
				MarkdownDescription: "Query string for Level names. Optional",
			},
			"sort_method": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
...
type ComplianceLevelDataSourceModel struct {
...
func (t ItemsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	complianceProgramIdAttribute, ok := attributes["compliance_program_id"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`compliance_program_id is missing from object`)

		return nil, diags
	}

	complianceProgramIdVal, ok := complianceProgramIdAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`compliance_program_id expected to be basetypes.Int64Value, was: %T`, complianceProgramIdAttribute))
	}
	...
	return ItemsValue{
		ComplianceProgramId: complianceProgramIdVal,
...
type ItemsValue struct {
	ComplianceProgramId basetypes.Int64Value  `tfsdk:"compliance_program_id"`
...
func (v ItemsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["compliance_program_id"] = basetypes.Int64Type{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.ComplianceProgramId.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["compliance_program_id"] = val
...
func (v ItemsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	attributeTypes := map[string]attr.Type{
		"compliance_program_id": basetypes.Int64Type{},
	...
	objVal, diags := types.ObjectValue(
		attributeTypes,
		map[string]attr.Value{
			"compliance_program_id": v.ComplianceProgramId,
...
func (v ItemsValue) Equal(o attr.Value) bool {
	...
	if !v.ComplianceProgramId.Equal(other.ComplianceProgramId) {
		return false
	}
