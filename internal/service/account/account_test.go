...
func TestAccKionAccount_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAccountConfigBasic(rName, payerID, accountNumber),
...
func TestAccKionAccount_update(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccAccountConfigUpdate(rName, payerID, accountNumber),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrSet(resourceName, "id"),
				),
			},
...
func testAccAccountConfigBasic(rName, payerID, accountNumber string) string {
	return fmt.Sprintf(`
...
func testAccAccountConfigUpdate(rName, payerID, accountNumber string) string {
	return fmt.Sprintf(`
resource "kion_account" "test" {
  name           = "%[1]s-updated"
  payer_id       = %[2]s
