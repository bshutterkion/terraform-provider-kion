...
var attrMinKionVersion = map[string]conns.KionVersion{
	"automation_policy_ids": conns.MustParseKionVersion("3.16.0"),
}

var _ resource.ResourceWithModifyPlan = &cloud_ruleResource{}
...
func (r *cloud_ruleResource) ModifyPlan(_ context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
	if req.Plan.Raw.IsNull() {
		return
	}
	resp.Diagnostics.Append(framework.RequireKionVersionInRange(r.Meta(), minKionVersion, maxKionVersion, "kion_cloud_rule")...)
	resp.Diagnostics.Append(framework.RequireAttrKionVersions(r.Meta(), req.Plan, attrMinKionVersion, "kion_cloud_rule")...)
}
