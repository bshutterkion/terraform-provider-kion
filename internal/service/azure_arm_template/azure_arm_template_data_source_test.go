...
func TestAccKionAzureArmTemplateDataSource_basic(t *testing.T) {
	if testing.Short() {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureArmTemplateDataSourceConfigBasic(rName, regionID),
...
func testAccAzureArmTemplateDataSourceConfigBasic(rName, regionID string) string {
	return fmt.Sprintf(`
...
data "kion_azure_arm_template" "test" {
  id = kion_azure_arm_template.test.id
}
`, rName, regionID)
}
