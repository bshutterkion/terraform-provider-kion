...
var _ resource.ResourceWithModifyPlan = &account_linkageResource{}
...
func (r *account_linkageResource) ModifyPlan(_ context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
	...
	resp.Diagnostics.Append(framework.RequireAttrKionVersions(r.Meta(), req.Plan, attrMinKionVersion, "kion_account_linkage")...)
}
