...
// sweepComplianceFamily paginates GetComplianceFamilyPaginatedIndex collecting ids whose test resources
// carry the acceptance-test prefix, then deletes them via DeleteComplianceFamily.
