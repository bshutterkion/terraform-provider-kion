...
func TestAccKionAwsAccountDataSource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAwsAccountDataSourceConfig_basic(rName, payerID, accountNumber),
...
func testAccAwsAccountDataSourceConfig_basic(rName, payerID, accountNumber string) string {
	return fmt.Sprintf(`
