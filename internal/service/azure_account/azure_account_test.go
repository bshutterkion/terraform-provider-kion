...
func TestAccKionAzureAccount_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAzureAccountConfig_basic(rName, payerID, subscriptionUUID),
...
func TestAccKionAzureAccount_update(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccAzureAccountConfig_update(rName, payerID, subscriptionUUID),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrSet(resourceName, "id"),
				),
			},
...
func testAccAzureAccountConfig_basic(rName, payerID, subscriptionUUID string) string {
	return fmt.Sprintf(`
...
func testAccAzureAccountConfig_update(rName, payerID, subscriptionUUID string) string {
	return fmt.Sprintf(`
resource "kion_permission_scheme" "test_perm" {
  name = "%[1]s-perm"
  type = "ou"
