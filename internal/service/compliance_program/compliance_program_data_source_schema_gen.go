...
func ComplianceProgramDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"data": schema.SingleNestedAttribute{
						...
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								...
								"managed_resource_library_checksum": schema.StringAttribute{
									Computed:            true,
									Description:         "The checksum for the compliance program in our resource library.",
									MarkdownDescription: "The checksum for the compliance program in our resource library.",
								},
								"managed_resource_library_id": schema.StringAttribute{
									Computed:            true,
									Description:         "The ID of the compliance program in our resource library.",
									MarkdownDescription: "The ID of the compliance program in our resource library.",
								},
								...
								"parent_program_id": schema.Int64Attribute{
									Computed:            true,
									Description:         "ParentProgramID of the compliance program.",
									MarkdownDescription: "ParentProgramID of the compliance program.",
								},
								"system_managed_program": schema.BoolAttribute{
									Computed:            true,
									Description:         "True if the compliance program is managed by Kion.",
									MarkdownDescription: "True if the compliance program is managed by Kion.",
								},
				...
				Computed:            true,
				Description:         "ComplianceProgramPaginated defines a paginated list of compliance programs.",
				MarkdownDescription: "ComplianceProgramPaginated defines a paginated list of compliance programs.",
			},
			"page": schema.Int64Attribute{
				Optional:            true,
				Computed:            true,
			...
			"query": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "Query string for program names. Optional",
				MarkdownDescription: "Query string for program names. Optional",
			},
			"sort_method": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"system_managed_only": schema.BoolAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "Retrieve only system managed compliance programs.",
				MarkdownDescription: "Retrieve only system managed compliance programs.",
			},
		},
...
type ComplianceProgramDataSourceModel struct {
	...
	SystemManagedOnly types.Bool   `tfsdk:"system_managed_only"`
}
...
func (t ItemsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	groupingTypeAttribute, ok := attributes["grouping_type"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`grouping_type is missing from object`)

		return nil, diags
	}

	groupingTypeVal, ok := groupingTypeAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`grouping_type expected to be basetypes.StringValue, was: %T`, groupingTypeAttribute))
	}
	...
	managedResourceLibraryChecksumAttribute, ok := attributes["managed_resource_library_checksum"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`managed_resource_library_checksum is missing from object`)

		return nil, diags
	}

	managedResourceLibraryChecksumVal, ok := managedResourceLibraryChecksumAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`managed_resource_library_checksum expected to be basetypes.StringValue, was: %T`, managedResourceLibraryChecksumAttribute))
	}

	managedResourceLibraryIdAttribute, ok := attributes["managed_resource_library_id"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`managed_resource_library_id is missing from object`)

		return nil, diags
	}

	managedResourceLibraryIdVal, ok := managedResourceLibraryIdAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`managed_resource_library_id expected to be basetypes.StringValue, was: %T`, managedResourceLibraryIdAttribute))
	}
	...
	parentProgramIdAttribute, ok := attributes["parent_program_id"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`parent_program_id is missing from object`)

		return nil, diags
	}

	parentProgramIdVal, ok := parentProgramIdAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`parent_program_id expected to be basetypes.Int64Value, was: %T`, parentProgramIdAttribute))
	}

	systemManagedProgramAttribute, ok := attributes["system_managed_program"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`system_managed_program is missing from object`)

		return nil, diags
	}

	systemManagedProgramVal, ok := systemManagedProgramAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`system_managed_program expected to be basetypes.BoolValue, was: %T`, systemManagedProgramAttribute))
	}

	terseNameAttribute, ok := attributes["terse_name"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`terse_name is missing from object`)

		return nil, diags
	}

	terseNameVal, ok := terseNameAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`terse_name expected to be basetypes.StringValue, was: %T`, terseNameAttribute))
	}

	verboseNameAttribute, ok := attributes["verbose_name"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`verbose_name is missing from object`)

		return nil, diags
	}

	verboseNameVal, ok := verboseNameAttribute.(basetypes.StringValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`verbose_name expected to be basetypes.StringValue, was: %T`, verboseNameAttribute))
	}
	...
	return ItemsValue{
		...
		GroupingType:                   groupingTypeVal,
		Id:                             idVal,
		ManagedResourceLibraryChecksum: managedResourceLibraryChecksumVal,
		ManagedResourceLibraryId:       managedResourceLibraryIdVal,
		Name:                           nameVal,
		ParentProgramId:                parentProgramIdVal,
		SystemManagedProgram:           systemManagedProgramVal,
		TerseName:                      terseNameVal,
		VerboseName:                    verboseNameVal,
		Version:                        versionVal,
		state:                          attr.ValueStateKnown,
	}, diags
}
...
type ItemsValue struct {
	...
	GroupingType                   basetypes.StringValue `tfsdk:"grouping_type"`
	Id                             basetypes.Int64Value  `tfsdk:"id"`
	ManagedResourceLibraryChecksum basetypes.StringValue `tfsdk:"managed_resource_library_checksum"`
	ManagedResourceLibraryId       basetypes.StringValue `tfsdk:"managed_resource_library_id"`
	Name                           basetypes.StringValue `tfsdk:"name"`
	ParentProgramId                basetypes.Int64Value  `tfsdk:"parent_program_id"`
	SystemManagedProgram           basetypes.BoolValue   `tfsdk:"system_managed_program"`
	TerseName                      basetypes.StringValue `tfsdk:"terse_name"`
	VerboseName                    basetypes.StringValue `tfsdk:"verbose_name"`
...
func (v ItemsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["grouping_type"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["id"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["managed_resource_library_checksum"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["managed_resource_library_id"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["name"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["parent_program_id"] = basetypes.Int64Type{}.TerraformType(ctx)
	attrTypes["system_managed_program"] = basetypes.BoolType{}.TerraformType(ctx)
	attrTypes["terse_name"] = basetypes.StringType{}.TerraformType(ctx)
	attrTypes["verbose_name"] = basetypes.StringType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.GroupingType.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["grouping_type"] = val
		...
		val, err = v.ManagedResourceLibraryChecksum.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["managed_resource_library_checksum"] = val

		val, err = v.ManagedResourceLibraryId.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["managed_resource_library_id"] = val
		...
		val, err = v.ParentProgramId.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["parent_program_id"] = val

		val, err = v.SystemManagedProgram.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["system_managed_program"] = val

		val, err = v.TerseName.ToTerraformValue(ctx)
		...
		val, err = v.VerboseName.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["verbose_name"] = val
...
func (v ItemsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	attributeTypes := map[string]attr.Type{
		...
		"grouping_type":                     basetypes.StringType{},
		"id":                                basetypes.Int64Type{},
		"managed_resource_library_checksum": basetypes.StringType{},
		"managed_resource_library_id":       basetypes.StringType{},
		"name":                              basetypes.StringType{},
		"parent_program_id":                 basetypes.Int64Type{},
		"system_managed_program":            basetypes.BoolType{},
		"terse_name":                        basetypes.StringType{},
		"verbose_name":                      basetypes.StringType{},
	...
	objVal, diags := types.ObjectValue(
		...
		map[string]attr.Value{
			...
			"grouping_type":                     v.GroupingType,
			"id":                                v.Id,
			"managed_resource_library_checksum": v.ManagedResourceLibraryChecksum,
			"managed_resource_library_id":       v.ManagedResourceLibraryId,
			"name":                              v.Name,
			"parent_program_id":                 v.ParentProgramId,
			"system_managed_program":            v.SystemManagedProgram,
			"terse_name":                        v.TerseName,
			"verbose_name":                      v.VerboseName,
			"version":                           v.Version,
		})
...
func (v ItemsValue) Equal(o attr.Value) bool {
	...
	if !v.GroupingType.Equal(other.GroupingType) {
		return false
	}
	...
	if !v.ManagedResourceLibraryChecksum.Equal(other.ManagedResourceLibraryChecksum) {
		return false
	}

	if !v.ManagedResourceLibraryId.Equal(other.ManagedResourceLibraryId) {
		return false
	}
	...
	if !v.ParentProgramId.Equal(other.ParentProgramId) {
		return false
	}

	if !v.SystemManagedProgram.Equal(other.SystemManagedProgram) {
		return false
	}

	if !v.TerseName.Equal(other.TerseName) {
		return false
	}

	if !v.VerboseName.Equal(other.VerboseName) {
		return false
	}
