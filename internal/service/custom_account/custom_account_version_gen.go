...
var _ resource.ResourceWithModifyPlan = &custom_accountResource{}
...
func (r *custom_accountResource) ModifyPlan(_ context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
	if req.Plan.Raw.IsNull() {
		return
	}
	resp.Diagnostics.Append(framework.RequireKionVersionInRange(r.Meta(), minKionVersion, maxKionVersion, "kion_custom_account")...)
	resp.Diagnostics.Append(framework.RequireAttrKionVersions(r.Meta(), req.Plan, attrMinKionVersion, "kion_custom_account")...)
}
