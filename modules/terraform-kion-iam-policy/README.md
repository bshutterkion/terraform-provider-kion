# terraform-kion-iam-policy

Terraform module for `kion_iam_policy`, generated from the provider schema by
...
| Name | Type |
| ---- | ---- |
| [kion_iam_policy.this](https://registry.terraform.io/providers/kionsoftware/kion/1.0.0/docs/resources/iam_policy) | resource |
...
| Name | Description |
| ---- | ----------- |
| aws\_managed\_policy | aws\_managed\_policy of the kion\_iam\_policy. |
| id | id of the kion\_iam\_policy. |
| path\_suffix | path\_suffix of the kion\_iam\_policy. |
| system\_managed\_policy | system\_managed\_policy of the kion\_iam\_policy. |
<!-- END_TF_DOCS -->
