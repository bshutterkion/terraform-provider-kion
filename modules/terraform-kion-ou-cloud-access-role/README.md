...
| aws\_iam\_policies | IDs of the AWS IAM policies attached to this role. | `list(number)` | `null` | no |
...
| azure\_role\_definitions | IDs of the Azure Role Definitions attached to this role. | `list(number)` | `null` | no |
| gcp\_iam\_roles | IDs of the GCP IAM roles attached to this role. | `list(number)` | `null` | no |
