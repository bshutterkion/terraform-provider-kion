...
page_title: "kion_account Resource - kion"
subcategory: ""
description: |-
...
- `aws_organizational_unit` (Block, Optional) Where to place this account within AWS Organization when creating an account. (see [below for nested schema](#nestedblock--aws_organizational_unit))
...
- `move_project_settings` (Block, Optional) Parameters used when moving an account between Kion projects.  These settings are ignored unless moving an account. (see [below for nested schema](#nestedblock--move_project_settings))
